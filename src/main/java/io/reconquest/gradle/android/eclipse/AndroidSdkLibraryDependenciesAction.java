...
public class AndroidSdkLibraryDependenciesAction implements Action<Classpath> {
  ...
  private ClasspathEntry androidSdkEntry() {
    ...
    Variable variable =
        new Variable(
            fileReferenceFactory.fromPath(
                "ANDROID_HOME/platforms/" + compileSdkVersion + "/android.jar"));
    variable.setSourcePath(
        fileReferenceFactory.fromPath("ANDROID_HOME/sources/" + compileSdkVersion));
    return variable;
  }
